(function (global, factory) {
    ...
    var SignUpComponent = /** @class */ (function () {
        function SignUpComponent(fb, http, router$$1, dialog$$1, apiService) {
            ...
            this.signUpForm = this.fb.group({
                ...
                password: ['', forms.Validators.required],
                confirmpassword: [null, forms.Validators.required],
                zip: [null, forms.Validators.required],
                city: [null, forms.Validators.required],
    ...
    var ResetPasswordComponent = /** @class */ (function () {
        function ResetPasswordComponent(fb, http, router$$1, route, apiService, cookieService) {
            var _this = this;
            this.fb = fb;
            this.http = http;
            this.router = router$$1;
